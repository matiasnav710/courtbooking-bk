...
export class SchemaUpdate1693917847363 implements MigrationInterface {
    name = 'SchemaUpdate1693917847363'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "court" ADD "venueId" integer`);
        await queryRunner.query(`ALTER TABLE "court" ADD CONSTRAINT "UQ_3a8965820bd95c8827a247ab192" UNIQUE ("venueId")`);
        await queryRunner.query(`ALTER TABLE "court" ADD "sportId" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "court" DROP COLUMN "sportId"`);
        await queryRunner.query(`ALTER TABLE "court" DROP CONSTRAINT "UQ_3a8965820bd95c8827a247ab192"`);
        await queryRunner.query(`ALTER TABLE "court" DROP COLUMN "venueId"`);
    }
